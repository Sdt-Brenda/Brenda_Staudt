...
select * from empleados where apellido in (select distinct apellido from empleados) order by emplaedo_id asc;

-- d) Lista el nombre y apellido de todos los empleados.
select nombre, apellido from empleados where apellido in (select distinct apellido from empleados);
...
select concat(nombre, ' ', apellido) as nombre_completo from empleados where apellido in (select distinct apellido from empleados);

-- g) Lista el nombre y apellido de los empleados en una única columna, convirtiendo todos los caracteres en mayúscula.
select upper(concat(nombre, ' ', apellido)) as nombre_completo from empleados where apellido in (select distinct apellido from empleados);

-- h) Lista el nombre y apellido de los empleados en una única columna, convirtiendo todos los caracteres en minúscula.
select lower(concat(nombre, ' ', apellido)) as nombre_completo from empleados where apellido in (select distinct apellido from empleados);

-- i) Lista el nombre de los departamentos y el valor del presupuesto actual ordenado de forma ascendente.
select * from departamentos ORDER BY presupuesto ASC;
...
select concat(apellido, ' ', nombre) as nombre_completo from empleados where apellido in (select distinct apellido from empleados) order by nombre_completo ASC;
...
select empleados.apellido, empleados.nombre, departamentos.nombre, departamentos.presupuesto, departamentos.estado from empleados inner join departamentos on empleados.emplaedo_id = departamentos.departamento_id;
...
select departamentos.nombre, empleados.apellido, empleados.nombre, departamentos.presupuesto, departamentos.estado from empleados inner join departamentos on emplaedo_id = departamentos.departamento_id order by departamentos.nombre ASC;
...
select departamento_id as codigo, nombre from departamentos where departamento_id in(select departamento from empleados);

-- v) Devuelve el nombre del departamento donde trabaja el empleado que tiene el cuit 27-38382980-3.
select departamentos.nombre from departamentos where departamentos.departamento_id in(select empleados.departamento from empleados where empleados.cuil_cuit = '27-38382980-3');
...
select * from empleados where departamento in(select departamento_id from departamentos where nombre = 'I+D') order by apellido;
...
select * from empleados where departamento in(select departamento_id from departamentos where nombre in ('Sistemas', 'Contabilidad', 'I+D')) order by apellido;
